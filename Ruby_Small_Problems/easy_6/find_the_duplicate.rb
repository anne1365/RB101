...
UNDERSTANDING THE PROBLEM:
  INPUTS  --> array with one duplicate
  OUTPUTS --> integer representing one duplicated element in array
  IDEAS:
    - make a new array by adding input array's elements one by one. Before add-
      ing, check if new array contains selected element from input array
...
ALGORITHM / PSEUDOCODE:
  ...
  - iterate through input array, adding each element to new array if new array
    doesn't already include it
  - if it does, return the selected element, otherwise keep iterating
